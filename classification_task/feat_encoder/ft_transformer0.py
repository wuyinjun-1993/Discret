...
class Transformer_wrapper(nn.Module):
    def __init__(self, model, num_dim):
    ...
    def forward(self, x): 
        X_num, X_cat = x[:, :self.num_dim], x[:, self.num_dim:]
        
        return self.model.forward(X_cat.type(torch.long), X_num)
...
class FTTransformer(nn.Module):
    ...
    def forward(self, x_categ, x_numer, return_embedding=False):
